...
function preload() {
  ...
  characters.push(new Character(100,100,80,80,'limeSprite.png',animations));
  characters.push(new Character(200,100,80,80,'PurpleWoman.png',animations));
  characters.push(new Character(250,100,80,80,'RoundBoy.png',animations));
}
